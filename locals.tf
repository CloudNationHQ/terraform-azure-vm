...
locals {
  data_disks = [
    for disk_key, disk in try(var.instance.disks, {}) : {
      ...
      on_demand_bursting_enabled        = try(disk.on_demand_bursting_enabled, null)
      ...
      trusted_launch_enabled            = try(disk.trusted_launch_enabled, null)
      ...
      upload_size_bytes                 = try(disk.upload_size_bytes, null)
